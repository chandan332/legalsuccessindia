    ...
    <div class="row">
        <div class="col-md-4 ">
            <div class="tw-mt-10 tw-flex tw-flex-col tw-items-center tw-text-center tw-gap-2 tw-sticky tw-top-24">
                ...
                <h3 class="fw-font-normal tw-mb-4">Special pricing:<br /> FSSAI registration {{ $id }} package
                    starting at <span class="tw-font-extrabold"><span class="tw-line-through ">1999</span> ₹999</span> ,
